...
const ORDER_TABLE = "UserOrder-5h22bjwlqrfbrajtlotra23xrq-dev";
const ORDER_TYPE = "Order";
const BOOK_ORDER_TABLE = "BookOrder-5h22bjwlqrfbrajtlotra23xrq-dev";
...
exports.handler = async (event) => {
  try {
    ...
    // Note - Add another function to email the invoice to the user
