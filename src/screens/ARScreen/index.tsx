...
import { SearchableGooglePolyAssetList } from '../../components/ARComponents';
      ...
      <View style={{flex:1}}>
        ...
        <View style={{position:"absolute", bottom: 0, flex: 1, flexDirection: "row"}}>
          <View style={{flex: 1, flexDirection: "row", justifyContent: "space-between"}}>
            <MaterialCommunityIcons.Button size={40} name="plus" backgroundColor="transparent" onPress={this.onAddObjectPress} />
            <MaterialCommunityIcons.Button size={40} name="magnify" backgroundColor="transparent" onPress={this.onSearchModalPress} />
            <MaterialCommunityIcons.Button size={40} name="minus" backgroundColor="transparent" onPress={this.onRemoveObjectPress} />
          </View>
        </View>
